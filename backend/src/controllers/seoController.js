 ...
 */
exports.obtenerSEOPagina = async (req, res) => {
  try {
    const { pagina } = req.params;
    console.log(`Generando SEO para página: ${pagina}`);
    ...
    const seoPages = {
      inicio: {
        titulo: "Tractodo - Refaccionaria Especializada en Tractocamión | Querétaro",
        descripcion: "Refaccionaria especializada en partes para tractocamión. Venta de cabezas de motor, turbos, árboles de levas y refacciones para motores Cummins, Caterpillar, Detroit. Envío nacional.",
        palabrasClave: ["refaccionaria tractocamión", "partes para tractocamión", "cabeza de motor", "turbo tractocamión", "refacciones Cummins", "Querétaro"],
        url: "/"
      },
      sobre: {
        titulo: "Sobre Nosotros - Historia y Misión | Tractodo Refaccionaria",
        descripcion: "Conoce la historia de Tractodo. Más de 15 años especializados en refacciones para tractocamión en Querétaro. Misión, visión y valores de nuestra refaccionaria.",
        palabrasClave: ["sobre tractodo", "historia refaccionaria", "misión tractodo", "visión refaccionaria", "valores empresa", "refaccionaria querétaro", "15 años experiencia"],
        url: "/sobre"
      },
      productos: {
        titulo: "Refacciones para Tractocamión | Catálogo Completo | Tractodo",
        descripcion: "Catálogo completo de refacciones para tractocamión. Partes originales y compatibles para motores Cummins, Caterpillar, Detroit, Volvo. Envío nacional, precios competitivos.",
        palabrasClave: ["refacciones tractocamión", "partes para motor", "cabeza de motor", "turbo", "árbol de levas", "Cummins", "Querétaro"],
        url: "/productos"
      },
      ubicacion: {
        titulo: "Ubicación y Contacto | Tractodo Querétaro - San Juan del Río",
        descripcion: "Visítanos en San Juan del Río, Querétaro. Dirección, horarios de atención, teléfonos de contacto. Refaccionaria Tractodo, especialistas en tractocamión.",
        palabrasClave: ["ubicación tractodo", "dirección refaccionaria", "san juan del río", "querétaro", "contacto tractodo", "horarios atención"],
        url: "/ubicacion"
      },
      entretenimiento: {
        titulo: "Entretenimiento Tractodo | Videos y Blog de Tractocamión",
        descripcion: "Contenido de entretenimiento para transportistas. Videos educativos, shorts divertidos y blog con consejos, promociones y casos de éxito en el mundo del tractocamión.",
        palabrasClave: ["entretenimiento tractocamión", "videos transportistas", "blog tractocamión", "shorts divertidos", "consejos transportistas"],
        url: "/entretenimiento"
      },
      videos: {
        titulo: "Videos Educativos | Tractodo - Contenido para Transportistas",
        descripcion: "Videos educativos y entretenidos sobre tractocamiones, mantenimiento, consejos para transportistas y contenido divertido del mundo del transporte pesado.",
        palabrasClave: ["videos tractocamión", "videos transportistas", "mantenimiento tractocamión", "consejos transporte", "videos educativos"],
        url: "/videos"
      },
      blog: {
        titulo: "Blog Tractodo | Consejos, Promociones y Casos de Éxito",
        descripcion: "Blog especializado en tractocamiones. Consejos de mantenimiento, promociones exclusivas, casos de éxito y preguntas frecuentes sobre refacciones para transporte pesado.",
        palabrasClave: ["blog tractocamión", "consejos mantenimiento", "promociones refacciones", "casos de éxito", "preguntas frecuentes"],
        url: "/blog"
      }
    };

    const datosSEO = seoPages[pagina];
    
    if (!datosSEO) {
      return res.status(404).json({
        error: "Página no encontrada",
        mensaje: `No hay configuración SEO para la página: ${pagina}`
      });
    }
    ...
    const seoCompleto = {
      ...datosSEO,
      imagenPrincipal: `${baseURL}/images/${pagina}-hero.jpg`,
      sitio: "Tractodo",
      tipo: "website",
      idioma: "es-MX",
      region: "MX",
      telefono: "+52-427-224-5923",
      direccion: "San Cayetano, Río Extoras 56 Querétaro, San Juan del Río",
      fechaGeneracion: new Date().toISOString()
    };

    console.log(`✅ SEO generado para página ${pagina}:`, seoCompleto);
    res.json(seoCompleto);

  } catch (error) {
    console.error(`Error generando SEO para página ${pagina}:`, error.message);
    res.status(500).json({
      error: "Error al generar datos SEO de la página",
      detalles: error.message
    });
  }
};